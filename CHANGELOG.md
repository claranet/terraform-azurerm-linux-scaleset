...
`disable_automatic_rollback` is replaced by `automatic_rollback_enabled`; the module input
`automatic_rollback_enabled` keeps its meaning, only the provider argument flips. Two
...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 0474ba0

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 c673675
* **deps:** update dependency tflint to v0.64.0 04f0ca1
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 34c22e2
* **v9:** 🐛 synchronize common files and docs 663eb12

## 8.0.8 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug 4cab8a0

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 1f058f2
* **deps:** update dependency opentofu to v1.12.2 654a198
* **deps:** update dependency opentofu to v1.12.3 531cc99
* **deps:** update dependency opentofu to v1.12.4 801f05a
* **deps:** update dependency tflint to v0.63.1 0f11d51
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 7bc057f
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 d311a77
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 2cdad37
* **deps:** update tools 7337cc9

## 8.0.7 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 80de35b

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu c2d41bd
* **deps:** update dependency terraform-docs to v0.23.0 4ceb5b7
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 c30fa22
* **deps:** update tools 4c6eabb
* **pre-commit:** 🔧 move to prek 9980180
* **tfdocs:** bump tfdocs to v0.22 🔧 dfb1007

## 8.0.6 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 9427afb

### Code Refactoring

* update module structure and Github actions 👷 a7d08a5

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing f0cc4ae
* **deps:** 🔗 bump tflint rules version be607c1
* **deps:** update dependency trivy to v0.69.2 bc40257
* **deps:** update dependency trivy to v0.69.3 15e1208
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 d0a8b5b

## 8.0.5 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 cd5dfde

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 9e370f5
* **deps:** update dependency opentofu to v1.11.2 12a66ea
* **deps:** update dependency opentofu to v1.11.3 71a65b3
* **deps:** update dependency opentofu to v1.11.4 b7c8fc7
* **deps:** update dependency opentofu to v1.11.5 583baf7
* **deps:** update dependency pre-commit to v4.4.0 395198f
* **deps:** update dependency pre-commit to v4.5.0 990b93b
* **deps:** update dependency pre-commit to v4.5.1 0e125bd
* **deps:** update dependency tflint to v0.60.0 693dfd0
* **deps:** update dependency tflint to v0.61.0 efa590f
* **deps:** update dependency trivy to v0.68.1 340b25e
* **deps:** update dependency trivy to v0.68.2 24821cd
* **deps:** update dependency trivy to v0.69.0 4c79078
* **deps:** update dependency trivy to v0.69.1 904b9df
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 51d0cbb
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 a32bbd5
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 97446be
* **deps:** update tools f5b3367
